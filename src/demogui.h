...
class m_Dialog : public wxDialog
{
	...
	public:
		...
		m_Dialog( wxWindow* parent, wxWindowID id = wxID_ANY, const wxString& title = wxT("demo"), const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxDefaultSize, long style = wxDEFAULT_DIALOG_STYLE|wxRESIZE_BORDER );
		~m_Dialog();
